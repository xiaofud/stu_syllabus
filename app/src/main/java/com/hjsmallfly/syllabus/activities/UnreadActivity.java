...
import com.hjsmallfly.syllabus.mvp.model.UnReadPostsModel;
import com.hjsmallfly.syllabus.mvp.presenter.UnreadPresenter;
import com.hjsmallfly.syllabus.pojo.PostList;
import com.hjsmallfly.syllabus.syllabus.R;
import com.umeng.analytics.MobclickAgent;

public class UnreadActivity extends AppCompatActivity implements PostsContract.PostsView{
...
//    public static final int NUMBER_OF_POSTS_PER_PULL = 10;  // 每次拉取的文章数量
    ...
    private PostsContract.UnreadPresenter presenter;
...
//        PostsModel postsModel = new PostsModel();
        UnReadPostsModel unReadPostsModel = new UnReadPostsModel();
        presenter = new UnreadPresenter(this, unReadPostsModel);

        // 拉取数据
        presenter.getUnreadMessage(MainActivity.user_id, UNREAD_TYPE);
    }
    ...
    protected void setup_views(){
        ...
        view_more_button.setVisibility(View.GONE);
        ...
        switch (item.getItemId()){
            ...
            case R.id.personal_info_action:
                if (MainActivity.user_id == -1){
                    Toast.makeText(UnreadActivity.this, "亲, 请同步一次课表", Toast.LENGTH_SHORT).show();
                    return true;
                }
...
//        currentMinID = postList.postList.get(postList.postList.size() - 1).id;
    ...
    public void showMessage(String message){
        Toast.makeText(UnreadActivity.this, message, Toast.LENGTH_SHORT).show();
    }
